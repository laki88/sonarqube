...
public class ShortBranchTrackerExecution {
  ...
  public ShortBranchTracking track(Component component) {
    ...
    Tracking<DefaultIssue, DefaultIssue> baseTracking = tracker.track(rawInput, baseInput);
    ...
    // do second tracking with merge branch using raws issues that are still unmatched
    Tracking<DefaultIssue, DefaultIssue> mergeBranchTracking = tracker.track(unmatchedRawInput, mergeInput);

    return new ShortBranchTracking(baseTracking, mergeBranchTracking);
  }
